...
public class UsuarioDao {
	...
	public boolean validarUpdate(String email,int codigo) throws SQLException {
		String sql = "select count(1) as qtd from usuario where email = '" + email + "' and codigo_usuario != " + codigo + "";
		PreparedStatement statement = connection.prepareStatement(sql);
		ResultSet resultSet = statement.executeQuery();
		int reg = 0;
		if (resultSet.next()) {
