...
public class LevelOneState implements State {
    ...
    private final Rectangle p1 = new Rectangle(15, (Game.HEIGTH - 100) / 2, 10, 100);
    ...
    public void render(Graphics g) {
        ...
        g.fillRect(Game.WIDTH / 2 + 10 - 3, 0, 6, Game.HEIGTH);
    ...
    public void KeyPressed(int cod) {
        if (jogo) {
            if (cod == KeyEvent.VK_UP && p1.y > 0) {
                p1.y -= 5;
            } else if (cod == KeyEvent.VK_DOWN && p1.y < Game.HEIGTH - p1.height) {
                p1.y += 5;
