...
public class TelaEmpresaAlterar extends javax.swing.JDialog {

    private int codigo;

    public TelaEmpresaAlterar(java.awt.Frame parent, boolean modal, int c) {
        super(parent, modal);
        initComponents();
        carregarCadastro(c);
        codigo = c;
    ...
    private TelaEmpresaAlterar(JFrame jFrame, boolean b) {

    }

    private void carregarCadastro(int codigo) {
        EmpresaDao dao = new EmpresaDao();
        Empresa empresa = dao.buscarPorCodigo(codigo);
        jComboBoxSistema.setSelectedItem(empresa.getSistema());
        jDateChooser1.setDate(empresa.getDataCadastro());
        jTextFieldRazaoSocial.setText(empresa.getNomeEmpresa());
        jTextFieldProprietario.setText(empresa.getNomeProprietario());
        jFormattedTextFieldCnpj.setText(empresa.getCnpj());
        jComboBoxEstado.setSelectedItem(empresa.getEstado());
        ...
        jFormattedTextFieldCep.setText(empresa.getCep());
        jTextFieldEmail.setText(empresa.getEmail());
        jFormattedTextFieldTelefone.setText(empresa.getTelefone());
        jPasswordFieldSenha.setText(empresa.getSenhaEmpresa());
        jComboBoxSituacion.setSelectedItem(empresa.getSituacao());
        jTextField1Mensalidade.setText(String.valueOf(empresa.getMensalidade()));
        jTextFieldNumBanco.setText(String.valueOf(empresa.getNumeroBanco()));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jDateChooser1.getDate() == null) {
            JOptionPane.showMessageDialog(rootPane, "Preencha o campo data de cadastro");
            ...
            empresa.setDataCadastro(jDateChooser1.getDate());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEmpresaAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaEmpresaAlterar dialog = new TelaEmpresaAlterar(new javax.swing.JFrame(), true);
