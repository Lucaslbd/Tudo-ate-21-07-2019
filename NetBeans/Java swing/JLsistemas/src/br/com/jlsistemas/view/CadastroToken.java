...
public class CadastroToken extends javax.swing.JFrame {

    

    public CadastroToken() {
        initComponents();       
        preencherTabela("select * from token");
    }   
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro do token do boleto fácil");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().isEmpty()) {
            ...
            try (Connection conexao = ConexaoBD.conectar()) {
                ...
                comando.setString(1, jTextField1.getText());
                comando.setInt(2, 1);
                comando.executeUpdate();
                conexao.close();
                JOptionPane.showMessageDialog(null, "Token alterado com sucesso");
                preencherTabela("select * from token");
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "Erro ao alterar token" + ex);
            }
        }
    ...
    private void preencherTabela(String sql) {
        ...
        try {
            ...
            while (resultado.next()) {
                dados.add(new Object[]{resultado.getString("token")});
            }
            conexao.close();
        } catch (SQLException ex) {
        ...
        jTablePadrao.getColumnModel().getColumn(0).setPreferredWidth(500);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroToken.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroToken().setVisible(true);
            }
        });
    }
