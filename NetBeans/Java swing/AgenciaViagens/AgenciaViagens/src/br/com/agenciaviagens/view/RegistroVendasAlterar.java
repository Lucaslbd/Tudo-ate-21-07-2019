...
public class RegistroVendasAlterar extends javax.swing.JDialog {

       Empresa empresa;
    int codigo;
    Carregar carregar = new Carregar();

    public RegistroVendasAlterar(java.awt.Frame parent, boolean modal, Empresa e, int c) {
        super(parent, modal);
        initComponents();
        empresa = e;
        preecherComboBox();
    ...
    private RegistroVendasAlterar(JFrame jFrame, boolean b) {

    }

    private void preencherCampos() {
        VendaDao dao = new VendaDao();
        Venda venda = dao.buscarCodigo(codigo, empresa);        
        jComboBoxFornecedor.setSelectedItem(venda.getFornecedor());
        jComboBoxCliente.setSelectedItem(venda.getCliente());
        jComboBoxFuncionario.setSelectedItem(venda.getFuncionario());
        jTextFieldValorVenda.setText(String.valueOf(venda.getValorVenda()));
        jTextFieldValorComissao.setText(String.valueOf(venda.getValorReceber()));
        jDateChooserDataVenda.setDate(venda.getDataVenda());
        jDateChooserDataComissao.setDate(venda.getDataReceber());
        jComboBoxServico.setSelectedItem(venda.getDescricao());
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED), "Dados da venda"));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jComboBoxServico, 0, 236, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jDateChooserDataVenda, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 144, Short.MAX_VALUE)
                    .addComponent(jDateChooserDataComissao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jDateChooserDataVenda, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroVendasAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RegistroVendasAlterar dialog = new RegistroVendasAlterar(new javax.swing.JFrame(), true);
