...
public class CadastroFornecedorAlterar extends javax.swing.JDialog {

    int id;
    Empresa empresa;

    public CadastroFornecedorAlterar(java.awt.Frame parent, boolean modal, int codigo,Empresa e) {
        super(parent, modal);
        initComponents();        
        id = codigo;
        empresa = e;
    ...
    private void preencherCampos(int codigo) {
        ...
        Fornecedor fornecedor = dao.buscarCodigo(codigo,empresa);
    ...
    private CadastroFornecedorAlterar(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED), "Informações de cadastro"));
        ...
        jButton1.setToolTipText("Alterar cadastrado");
        ...
        jButton2.setToolTipText("Cancelar alteração");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextFieldNome.getText().isEmpty()) {
            ...
            dao.Alterar(fornecedor,empresa);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroFornecedorAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroFornecedorAlterar dialog = new CadastroFornecedorAlterar(new javax.swing.JFrame(), true);
