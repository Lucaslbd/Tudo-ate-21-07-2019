...
public class CadastroFornecedorNovo extends javax.swing.JDialog {

    Empresa usuarioLogado;

    public CadastroFornecedorNovo(java.awt.Frame parent, boolean modal, Empresa u) {
        super(parent, modal);
        initComponents();
        usuarioLogado = u;
    }

    private CadastroFornecedorNovo(JFrame jFrame, boolean b) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextFieldNome.getText().isEmpty()) {
            ...
            dao.Salvar(fornecedor,usuarioLogado);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroFornecedorNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroFornecedorNovo dialog = new CadastroFornecedorNovo(new javax.swing.JFrame(), true);
