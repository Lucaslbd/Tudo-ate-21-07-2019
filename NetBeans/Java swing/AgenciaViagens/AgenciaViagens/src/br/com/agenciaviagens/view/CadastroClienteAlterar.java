...
public class CadastroClienteAlterar extends javax.swing.JDialog {

    int codigo;
    Empresa empresa;

    public CadastroClienteAlterar(java.awt.Frame parent, boolean modal, int c, Empresa e) {
        super(parent, modal);
        initComponents();
        codigo = c;
        empresa = e;
    ...
    private CadastroClienteAlterar(JFrame jFrame, boolean b) {

    }

    private void preencherCampos() {
        ClienteDao dao = new ClienteDao();
        Cliente c = dao.buscarCodigo(codigo, empresa);
        ...
        jTextFieldEstado.setText(c.getEstado());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroClienteAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroClienteAlterar dialog = new CadastroClienteAlterar(new javax.swing.JFrame(), true);
