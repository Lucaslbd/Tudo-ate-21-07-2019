...
public class CadastroFuncionarioNovo extends javax.swing.JDialog {

    Empresa usuarioLogado;

    public CadastroFuncionarioNovo(java.awt.Frame parent, boolean modal, Empresa u) {
        super(parent, modal);
        initComponents();
        usuarioLogado = u;
    }

    private CadastroFuncionarioNovo(JFrame jFrame, boolean b) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jFormattedTextFieldCpf, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE))
                .addGap(51, 51, 51)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jTextFieldTelefone, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextFieldNome.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Prencha o campo comissionamento");//
            ...
            cliente.setSituacao("Contrato ativo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroFuncionarioNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroFuncionarioNovo dialog = new CadastroFuncionarioNovo(new javax.swing.JFrame(), true);
