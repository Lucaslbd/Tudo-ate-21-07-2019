...
public class TelaGastosNovo extends javax.swing.JDialog {
    
    Empresa usuarioLogado;
    
    public TelaGastosNovo(java.awt.Frame parent, boolean modal, Empresa u) {
        super(parent, modal);
        initComponents();
        usuarioLogado = u;
    }
    
    private TelaGastosNovo(JFrame jFrame, boolean b) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jTextFieldDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextFieldDescricao.getText().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Prencha o campo descricão");
            jTextFieldDescricao.requestFocus();       
        } else if (jDateChooser1.getDate() == null) {
            JOptionPane.showMessageDialog(rootPane, "Prencha o campo data");                 
        } else if (jTextFieldValor.getText().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Prencha o campo valor");
            ...
            dao.Salvar(gasto, usuarioLogado);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGastosNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaGastosNovo dialog = new TelaGastosNovo(new javax.swing.JFrame(), true);
