...
public class GruposNovo extends javax.swing.JDialog {

    Empresa empresa;

    public GruposNovo(java.awt.Frame parent, boolean modal, Empresa e) {
        super(parent, modal);
        initComponents();
        empresa = e;
    }

    private GruposNovo(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Total de passageiros");
        ...
        jLabel8.setText("Passageiros agregados");

        jLabel9.setText("Tripulação");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextFieldPax, javax.swing.GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jTextFieldPax.getText().isEmpty()) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Erro ao calcular verifique se todos os campos contem somente numeros ex(50) ou 50.50");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GruposNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GruposNovo dialog = new GruposNovo(new javax.swing.JFrame(), true);
