...
public class BoletoCliente extends javax.swing.JDialog {

    int codigo;
    Empresa empresa;

    public BoletoCliente(java.awt.Frame parent, boolean modal, int c, Empresa e) {
        super(parent, modal);
        initComponents();
        codigo = c;
        empresa = e;
        preencherTabela("select * from boleto inner join passageiro on passageiro = codigo_passageiro where codigo_passageiro = " + codigo + " order by vencimento");
    }

    private BoletoCliente(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Boleto do cliente");
    ...
    private void preencherTabela(String sql) {
        ...
        String[] colunas = new String[]{"Codigo", "Vencimento", "Valor","Numero da parcela", "Status"};
        try {
            Connection conexao;
            ...
            while (resultado.next()) {
                dados.add(new Object[]{resultado.getString("codigo_boleto"), dao.ArrrumaData(resultado.getDate("vencimento")), dao.DecimalFormat(resultado.getDouble("valor")),resultado.getInt("parcela"), resultado.getString("status")});
            }
            if (dados.size() < 1) {
                dados.add(new Object[]{"Boleto inexistente", "", "", "", ""});
            }
            conexao.close();
        ...
        jTablePadrao.getColumnModel().getColumn(0).setPreferredWidth(245);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BoletoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BoletoCliente dialog = new BoletoCliente(new javax.swing.JFrame(), true);
