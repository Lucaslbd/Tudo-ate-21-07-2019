...
public class ClientesAlterar extends javax.swing.JDialog {
    ...
    public ClientesAlterar(java.awt.Frame parent, boolean modal,int codigo) {
        super(parent, modal);
        initComponents();
    ...
    public void preencherCadastro(int codigo){
        conex.Conexao();
        conex.executaSql("select * from clientes where codigo='"+ codigo +"'");
           try {
               conex.rs.first();
               jTextFieldNome.setText(conex.rs.getString("nome"));
               jTextFieldNascimento.setText(conex.rs.getString("nascimento"));
    ...
    private ClientesAlterar(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldNascimento, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jTextFieldTelefone, javax.swing.GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE)
        ...
        jButton1.setText("Finalizar edição");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      if(jTextFieldNome.getText().isEmpty()){
          ...
          JOptionPane.showMessageDialog(rootPane,"O campo nascimento não pode estar vazio");
      ...
      clientes.setNascimento(jTextFieldNascimento.getText());
      clientes.setRg(jTextFieldRG.getText());
      clientes.setCpf(jTextFieldCPF.getText());
      clientes.setTelefone(jTextFieldTelefone.getText());
      clientes.setCodigo(Codigo);
      control.Editar(clientes);
      dispose();
      }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientesAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ClientesAlterar dialog = new ClientesAlterar(new javax.swing.JFrame(),true);
