...
public class Fornecedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxPesquisa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome do fornecedor", "Nome do responsavel", "CNPJ", "Cidade" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jComboBoxPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     FornecedoresNovo dialog = new FornecedoresNovo(new javax.swing.JFrame(), true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        FornecedoresAlterar dialog = new FornecedoresAlterar(new javax.swing.JFrame(), true,codigo); 
        dialog.setVisible(true);
        pesquisar();
        codigo=0;
}      
    ...
    public void pesquisar(){
        fornecedor.setPesquisar(jTextFieldPesquisa.getText());
        if(jComboBoxPesquisa.getSelectedItem().equals("Nome do fornecedor")) {
            preencherTabela("select *from fornecedores where nome ilike'%" + fornecedor.getPesquisar() + "%' order by nome");
        }else if(jComboBoxPesquisa.getSelectedItem().equals("Nome do responsavel")) {
            preencherTabela("select *from fornecedores where responsavel ilike'%" + fornecedor.getPesquisar() + "%' order by responsavel");
        }else if(jComboBoxPesquisa.getSelectedItem().equals("CNPJ")) {
            preencherTabela("select *from fornecedores where cnpj ilike'%" + fornecedor.getPesquisar() + "%' order by cnpj");
        }else if(jComboBoxPesquisa.getSelectedItem().equals("Cidade")) {
            preencherTabela("select *from fornecedores where cidade ilike'%" + fornecedor.getPesquisar() + "%' order by cidade");
        
        }
    }    
    public void preencherTabela(String sql) {
        ArrayList dados = new ArrayList();
        String[] colunas = new String[]{"ID","Nome","Telefone","CNPJ","Cidade","Email","Responsavel"};
        conex.Conexao();
        conex.executaSql(sql);
        try {
            conex.rs.first();
            do {
                dados.add(new Object[]{conex.rs.getInt("codigo"),conex.rs.getString("nome"), conex.rs.getString("fone"),conex.rs.getString("cnpj"),conex.rs.getString("cidade"),conex.rs.getString("email"),conex.rs.getString("responsavel")});
            } while (conex.rs.next());
        } catch (SQLException ex) {
