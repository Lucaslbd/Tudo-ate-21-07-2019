...
public class LucratividadeGrupos extends javax.swing.JFrame {
    ConexaoBD conex = new ConexaoBD();
    BeansGrupos grupos = new BeansGrupos();
    DaoGrupos control = new DaoGrupos();
    DecimalFormat df = new DecimalFormat("0.00");
    int codigo =0;
    public LucratividadeGrupos() {
        initComponents();
    }
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jTextFieldPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jLabel1.setText("Lucratividade dos grupos");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       grupos.setPesquisar(jTextFieldPesquisa.getText());        
       preencherTabela("select * from lucratividade_grupos where data_fechamento like'%" + grupos.getPesquisar() + "%' order by data_fechamento");
    ...
    countNotas+=Double.parseDouble(jTableClientes.getValueAt(i, 3).toString());
}
     String dx = df.format(countNotas);
     JOptionPane.showMessageDialog(null,"A valor lucrado é R$ "+ dx + " reais");
   ...
   if(codigo == 0){
       ...
       control.ExcluirLucratividade(grupos);
       codigo=0;
       grupos.setPesquisar(jTextFieldPesquisa.getText());        
       preencherTabela("select * from lucratividade_grupos where data_fechamento like'%" + grupos.getPesquisar() + "%' order by data_fechamento");
   }
    ...
    public void preencherTabela(String sql) {
        ...
        String[] colunas = new String[]{"Codigo","Nome","Data do fechamento","Valor"};
        conex.Conexao();
        conex.executaSql(sql);
        try {
            conex.rs.first();
            do {
                dados.add(new Object[]{conex.rs.getInt("codigo"),conex.rs.getString("nome"), conex.rs.getString("data_fechamento"), conex.rs.getDouble("valor_lucrado")});
            } while (conex.rs.next());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LucratividadeGrupos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LucratividadeGrupos().setVisible(true);
            }
        });
    }
