...
public class FornecedoresNovo extends javax.swing.JDialog {

    DaoFornecedor control = new DaoFornecedor();
    BeansFornecedores fornecedor = new BeansFornecedores();
    
    public FornecedoresNovo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FornecedoresNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
