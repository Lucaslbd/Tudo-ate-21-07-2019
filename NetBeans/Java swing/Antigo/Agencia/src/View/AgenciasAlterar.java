...
public class AgenciasAlterar extends javax.swing.JDialog {
   ConexaoBD conex = new ConexaoBD();
   BeansAgencia agencia = new BeansAgencia();
   DaoAgencia control = new DaoAgencia();
   int codig;
    public AgenciasAlterar(java.awt.Frame parent, boolean modal,int codigo) {
        super(parent, modal);
        initComponents();
        codig = codigo;
    ...
    private AgenciasAlterar(JFrame jFrame, boolean b) {
   ...
   public void preencherCadastro(int codigo){
        ...
        conex.executaSql("select * from agencias where codigo='"+ codigo +"'");
           try {
               ...
               jTextFieldCPFCnpj.setText(conex.rs.getString("cpfcnpj"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        agencia.setCodigo(codig);
        control.Editar(agencia);
        dispose();
         }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgenciasAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgenciasAlterar dialog = new AgenciasAlterar(new javax.swing.JFrame(), true);
