...
public class TelaFornecedor extends javax.swing.JFrame {
    ...
    private void jList2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList2MouseClicked
        ...
        preencherTabela("select * from fornecedor inner join empresa on empresa = codigo_empresa where empresa = " + usuario.getDeposito().getCodigo() + " and nome ='" + item + "'");
        jTextFieldPesquisa.setText(item);
        jList2.setVisible(false);
    }//GEN-LAST:event_jList2MouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        TelaFornecedorNovo dialog = new TelaFornecedorNovo(new javax.swing.JFrame(), true, usuario.getDeposito());
        dialog.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (selecionado == 0) {
            JOptionPane.showMessageDialog(rootPane, "Selecione um fornecedor para poder excluir");
        } else {
            JOptionPane.showMessageDialog(rootPane, "Ao remover um fornecedor também serão removidos seus respectivos registros");
            int resposta;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (selecionado == 0) {
            JOptionPane.showMessageDialog(rootPane, "Selecione um fornecedor para poder alterar");
        } else {
            TelaFornecedorAlterar dialog = new TelaFornecedorAlterar(new javax.swing.JFrame(), true, selecionado);
            dialog.setVisible(true);
            pesquisar();
            selecionado = 0;
        }
    ...
    private void PreencherLista() {
        if (jTextFieldPesquisa.getText().isEmpty()) {
            ...
            sql.append("select * from fornecedor inner join empresa on empresa = codigo_empresa where empresa = ").append(usuario.getDeposito().getCodigo()).append(" and nome ilike'%").append(jTextFieldPesquisa.getText()).append("%' order by nome");
            try {
                Connection conexao;
    ...
    private void pesquisar() {
        preencherTabela("select * from fornecedor inner join empresa on empresa = codigo_empresa where empresa = " + usuario.getDeposito().getCodigo() + " and nome ilike'%" + jTextFieldPesquisa.getText() + "%' order by nome");
    }

    public void preencherTabela(String sql) {
        ArrayList dados = new ArrayList();
        String[] colunas = new String[]{"Codigo", "Nome", "Telefone", "Email"};
        try {
            Connection conexao;
            conexao = ConexaoBD.conectar();
            ...
            ResultSet resultado = comando.executeQuery();
            while (resultado.next()) {
                dados.add(new Object[]{resultado.getInt("codigo_fornecedor"), resultado.getString("nome"), resultado.getString("telefone"), resultado.getString("email")});
            }
            conexao.close();
        } catch (SQLException ex) {
        ...
        jTablePadrao.getColumnModel().getColumn(1).setPreferredWidth(222);
        ...
        jTablePadrao.getColumnModel().getColumn(3).setPreferredWidth(233);
