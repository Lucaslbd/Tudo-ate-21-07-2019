...
public class TelaVeiculoAlterar extends javax.swing.JDialog {

    int codigo;

    public TelaVeiculoAlterar(java.awt.Frame parent, boolean modal, int d) {
        super(parent, modal);
        initComponents();
        codigo = d;
        preencherCampos(d);
    ...
    private TelaVeiculoAlterar(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Carro", "Moto", "Caminhão", "Outro" }));
        ...
        jLabel1.setText("Adicionar veiculo");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextFieldPlaca.getText().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "O campo placa não pode estar vazio");
            ...
            veiculo.setCategoria((String) jComboBox1.getSelectedItem());
    ...
    private void preencherCampos(int codigo) {
        ...
        jComboBox1.setSelectedItem(veiculo.getCategoria());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVeiculoAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaVeiculoAlterar dialog = new TelaVeiculoAlterar(new javax.swing.JFrame(), true);
