...
public class TelaVeiculoNovo extends javax.swing.JDialog {

    Deposito deposito;

    public TelaVeiculoNovo(java.awt.Frame parent, boolean modal, Deposito d) {
        super(parent, modal);
        initComponents();
        deposito = d;
    }

    private TelaVeiculoNovo(JFrame jFrame, boolean b) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVeiculoNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaVeiculoNovo dialog = new TelaVeiculoNovo(new javax.swing.JFrame(), true);
