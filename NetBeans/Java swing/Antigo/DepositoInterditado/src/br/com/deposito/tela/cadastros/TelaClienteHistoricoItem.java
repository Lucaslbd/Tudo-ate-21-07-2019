...
public class TelaClienteHistoricoItem extends javax.swing.JDialog {

    ArrayList<Item> historico = new ArrayList<>();
    ItemDao dao = new ItemDao();

    public TelaClienteHistoricoItem(java.awt.Frame parent, boolean modal, int codigo) {
        super(parent, modal);
        initComponents();
        historico = dao.ListarPorVenda(codigo);
        preencherTabela();
    }

    private TelaClienteHistoricoItem(JFrame jFrame, boolean b) {
    ...
    private void preencherTabela() {
        ...
        String[] colunas = new String[]{"Data", "Produto", "Qtd", "Tipo", "Pagamento", "Valor"};
        int i = 0;
        historico.forEach((t) -> {
            dados.add(new Object[]{util.ArrrumaData(t.getVenda().getData()), t.getProduto().getNome(), t.getQuantdade(), t.getVenda().getEntrega(), t.getVenda().getFormaPagamento(), util.DecimalFormat(t.getValor())});
        });
        ModeloTabela modelo = new ModeloTabela(dados, colunas);
        jTablePadrao.setModel(modelo);
        jTablePadrao.getColumnModel().getColumn(0).setPreferredWidth(90);
        ...
        jTablePadrao.getColumnModel().getColumn(2).setPreferredWidth(60);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaClienteHistoricoItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaClienteHistoricoItem dialog = new TelaClienteHistoricoItem(new javax.swing.JFrame(), true);
