...
public class TelaFornecedorAlterar extends javax.swing.JDialog {
    ...
    public TelaFornecedorAlterar(java.awt.Frame parent, boolean modal, int d) {
        super(parent, modal);
        initComponents();
        fornecedor = dao.buscarCodigo(d);
        preencherCampos();        
    }
    ...
    private void preencherCampos() {        
        jTextFieldFone.setText(fornecedor.getTelefone());        
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextFieldNome.getText().isEmpty()) {
            ...
            c.setCodigo(fornecedor.getCodigo());
            c.setDeposito(fornecedor.getDeposito());
            dao.Alterar(c);
            dispose();
        }
