...
public class TelaClienteAlterar extends javax.swing.JDialog {
    ...
    public TelaClienteAlterar(java.awt.Frame parent, boolean modal, int d) {
        super(parent, modal);
        initComponents();
        cliente = dao.buscarCodigo(d);
        preencherCampos();
    ...
    private TelaClienteAlterar(JFrame jFrame, boolean b) {
        
    }
    
    private void preencherCampos() {
        jTextFieldBBairro.setText(cliente.getBairro());
        ...
        jTextFieldn.setText(cliente.getNumero());
        jTextFieldRg.setText(cliente.getRg());
        jTextFieldRua.setText(cliente.getRua());
        jTextFieldFone.setText(cliente.getTelefone());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextFieldNome.getText().isEmpty()) {
            ...
            c.setBairro(jTextFieldBBairro.getText());
            ...
            c.setNumero(jTextFieldn.getText());
            c.setRg(jTextFieldRg.getText());
            c.setRua(jTextFieldRua.getText());
            c.setTelefone(jTextFieldFone.getText());
            c.setCodigo(cliente.getCodigo());
            c.setDeposito(cliente.getDeposito());
            dao.Alterar(c);
            dispose();
        }
    ...
    private void jTextFieldCidadeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCidadeKeyReleased
        if (jTextFieldCidade.getText().isEmpty()) {
            ...
            sql.append("select DISTINCT cliente_cidade from cliente inner join empresa on empresa = codigo_empresa where empresa = ").append(cliente.getDeposito().getCodigo()).append(" and ").append(pesquisa).append(" ilike'%").append(jTextFieldCidade.getText()).append("%' order by cliente_cidade");
            try {
                Connection conexao;
    ...
    private void jTextFieldBBairroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBBairroKeyReleased
        if (jTextFieldBBairro.getText().isEmpty()) {
            ...
            StringBuilder sql = new StringBuilder();
            sql.append("select DISTINCT cliente_bairro from cliente inner join empresa on empresa = codigo_empresa where empresa = ").append(cliente.getDeposito().getCodigo()).append(" and ").append(pesquisa).append(" ilike'%").append(jTextFieldBBairro.getText()).append("%' order by cliente_bairro");
            try {
                Connection conexao;
                conexao = ConexaoBD.conectar();
                PreparedStatement comando = conexao.prepareStatement(sql.toString());
    ...
    private void jTextFieldRuaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldRuaKeyReleased
        if (jTextFieldRua.getText().isEmpty()) {
            ...
            StringBuilder sql = new StringBuilder();
            sql.append("select DISTINCT cliente_rua from cliente inner join empresa on empresa = codigo_empresa where empresa = ").append(cliente.getDeposito().getCodigo()).append(" and ").append(pesquisa).append(" ilike'%").append(jTextFieldRua.getText()).append("%' order by cliente_rua");
            try {
                Connection conexao;
                conexao = ConexaoBD.conectar();
                PreparedStatement comando = conexao.prepareStatement(sql.toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            TelaClienteAlterar dialog = new TelaClienteAlterar(new javax.swing.JFrame(), true);
