...
public class TelaFuncionario extends javax.swing.JFrame {
    ...
    public TelaFuncionario(Usuario u) {
        initComponents();
        usuario = u;
    ...
    private void initComponents() {
        ...
        jComboBoxTipoPesquisa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "Cargo" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTextFieldPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jLabel1.setText("Tela de funcionário");
    ...
    private void jList2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList2MouseClicked
        ...
        preencherTabela("select * from funcionario inner join empresa on empresa = codigo_empresa where empresa = " + usuario.getDeposito().getCodigo() + " and "+pesquisa+" ='" + item + "'");
        jTextFieldPesquisa.setText(item);
        jList2.setVisible(false);
    }//GEN-LAST:event_jList2MouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        TelaFuncionarioNovo dialog = new TelaFuncionarioNovo(new javax.swing.JFrame(), true, usuario.getDeposito());
        dialog.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (selecionado == 0) {
            JOptionPane.showMessageDialog(rootPane, "Selecione um funcionário para poder excluir");
        } else {
            JOptionPane.showMessageDialog(rootPane, "Ao remover um funcionário também serão removidos seus respectivos registros");
            int resposta;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (selecionado == 0) {
            JOptionPane.showMessageDialog(rootPane, "Selecione um funcionário para poder alterar");
        } else {
            TelaFuncionarioAlterar dialog = new TelaFuncionarioAlterar(new javax.swing.JFrame(), true, selecionado);
            dialog.setVisible(true);
            pesquisar();
            selecionado = 0;
        }
    ...
    private void PreencherLista() {
        ...
        if (jTextFieldPesquisa.getText().isEmpty()) {
            ...
            sql.append("select DISTINCT ").append(pesquisa).append(" from funcionario inner join empresa on empresa = codigo_empresa where empresa = ").append(usuario.getDeposito().getCodigo()).append(" and ").append(pesquisa).append(" ilike'%").append(jTextFieldPesquisa.getText()).append("%' order by ").append(pesquisa).append("");
            try {
                Connection conexao;
    ...
    private void pesquisar() {        
        if (jComboBoxTipoPesquisa.getSelectedItem().equals("Nome")) {
            preencherTabela("select * from funcionario inner join empresa on empresa = codigo_empresa where empresa = " + usuario.getDeposito().getCodigo() + " and nome ilike'%" + jTextFieldPesquisa.getText() + "%' order by nome");
        } else if (jComboBoxTipoPesquisa.getSelectedItem().equals("Cargo")) {
           preencherTabela("select * from funcionario inner join empresa on empresa = codigo_empresa where empresa = " + usuario.getDeposito().getCodigo() + " and cargo ilike'%" + jTextFieldPesquisa.getText() + "%' order by nome");
        }
    ...
    public void preencherTabela(String sql) {
        ...
        String[] colunas = new String[]{"Codigo", "Nome", "Cpf", "Cargo", "Salario", "Status"};
        try {
            Connection conexao;
            conexao = ConexaoBD.conectar();
            ...
            ResultSet resultado = comando.executeQuery();
            while (resultado.next()) {
                dados.add(new Object[]{resultado.getInt("codigo_funcionario"), resultado.getString("nome"), resultado.getString("cpf"), resultado.getString("cargo"), util.DecimalFormat(resultado.getDouble("salario")), resultado.getString("situacao_funcionario")});
            }
            conexao.close();
        } catch (SQLException ex) {
        ...
        jTablePadrao.getColumnModel().getColumn(3).setPreferredWidth(132);
