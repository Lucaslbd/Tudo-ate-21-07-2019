...
public class Produto {
    ...
    public String toString() {
        return "Produto{" + "codigo=" + codigo + ", nome=" + nome + ", valorPortaria=" + valorPortaria + ", valorCasco=" + valorCasco + ", valorEntrega=" + valorEntrega + ", custoProduto=" + custoProduto + ", custoCasco=" + custoCasco + ", estoqueCheio=" + estoqueCheio + ", estoqueVazio=" + estoqueVazio + ", fornecedor=" + fornecedor + '}';
    }
