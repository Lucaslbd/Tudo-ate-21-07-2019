...
public class TelaUsuarioNovo extends javax.swing.JDialog {

    Deposito deposito;

    public TelaUsuarioNovo(java.awt.Frame parent, boolean modal, Deposito d) {
        super(parent, modal);
        initComponents();
        deposito = d;
    }

    private TelaUsuarioNovo(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador(a)", "Usuário(a)" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaUsuarioNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaUsuarioNovo dialog = new TelaUsuarioNovo(new javax.swing.JFrame(), true);
