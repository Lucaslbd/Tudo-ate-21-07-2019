...
public class TelaFornecedorNovo extends javax.swing.JDialog {

    Deposito deposito;

    public TelaFornecedorNovo(java.awt.Frame parent, boolean modal, Deposito d) {
        super(parent, modal);
        initComponents();
        deposito = d;
    }

    private TelaFornecedorNovo(JFrame jFrame, boolean b) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFornecedorNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
