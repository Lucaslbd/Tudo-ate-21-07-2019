...
public class TelaClienteAlterar extends javax.swing.JDialog {
    ...
    public TelaClienteAlterar(java.awt.Frame parent, boolean modal,Cliente cliente) {
        super(parent, modal);
        initComponents();
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jFormattedTextFieldCPF, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTextFieldNome.getText().isEmpty()) {
            ...
            cliente.setCodigo(Integer.parseInt(jLabelCodigo.getText()));
            dao.Alterar(cliente);
            if (!caminho.equals("")) {
                try {
                    Files.copy(Paths.get(caminho), Paths.get("C:\\Users\\Lucas\\Desktop\\projetos em java\\ProjetoVendas\\src\\uploads\\" + jTextFieldRG.getText() + ".jpg"));
    ...
    private void ReceberCliente(Cliente f) {
        jTextFieldNome.setText(f.getNome());
        jFormattedTextFieldCPF.setText(f.getCpf());
        jTextFieldRG.setText(f.getRg());
        jTextFieldFone.setText(f.getTelefone());
        jTextFieldEmail.setText(f.getEmail());
        jTextFieldCidade.setText(f.getCidade());
        jTextFieldBairro.setText(f.getBairro());
        jTextFieldRua.setText(f.getRua());
        jTextFieldnumero.setText(f.getNumero());
