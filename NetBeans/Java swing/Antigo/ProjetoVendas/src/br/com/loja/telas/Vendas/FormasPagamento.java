...
public class FormasPagamento extends javax.swing.JDialog {

    DecimalFormat df = new DecimalFormat("###,###,##0.00");

    public FormasPagamento(java.awt.Frame parent, boolean modal, int codigo) {
        super(parent, modal);
        initComponents();
        jLabel2.setText(String.valueOf(codigo));
        FormaPagamentoDao dao = new FormaPagamentoDao();
        ArrayList<FormaPagamento> lista  = dao.BuscaPagamento(codigo);       
        preencherTabela(lista);
    }

    private FormasPagamento(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pagamento referênte a venda numero");
    ...
    private void preencherTabela(ArrayList<FormaPagamento> l) {
        ArrayList dados = new ArrayList();
        String[] colunas = new String[]{"Forma pagamento", "Valor"};
        for (FormaPagamento i : l) {            
            String valorLucro = DecimalFortmat(i.getValorPagamento());            
           
            dados.add(new Object[]{i.getFormaPagamento(), valorLucro});
        }
        ModeloTabela modelo = new ModeloTabela(dados, colunas);
        jTablePadrao.setModel(modelo);
        jTablePadrao.getColumnModel().getColumn(0).setPreferredWidth(260);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormasPagamento dialog = new FormasPagamento(new javax.swing.JFrame(), true);
