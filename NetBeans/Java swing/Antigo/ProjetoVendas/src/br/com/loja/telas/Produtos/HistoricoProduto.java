...
public class HistoricoProduto extends javax.swing.JDialog {

    Produto produto;
    DecimalFormat df = new DecimalFormat("###,###,##0.00");//
    ArrayList<Item> lista;

    public HistoricoProduto(java.awt.Frame parent, boolean modal, Produto p) {
        super(parent, modal);
        initComponents();
        produto = p;
        jLabel1.setText(p.getDescricao());
    }

    private HistoricoProduto(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jButton4.setText("Somar lucro sob o produto");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jDateChooserData1.getDate() == null || jDateChooserData2.getDate() == null) {
            ...
            lista = new ArrayList<>();
            lista = dao.ListarPorProdutos(dataFormatada1, dataFormatada2, produto.getCodigo());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int count = 0;
        for (Item t : lista) {
            count += t.getQuantidade();
        }
        JOptionPane.showMessageDialog(null, "O total de vendidos é " + count + " unidades");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        double count = 0;
         for (Item t : lista) {
            count += t.getValorTotal();
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        double vendido = 0;
         for (Item t : lista) {
            vendido += t.getValorTotal();
        }
        double custo = 0;
        for (Item t : lista) {
            custo += t.getCusto() * t.getQuantidade();
        }
        double resultado = vendido - custo;
        String dx = df.format(resultado);
        JOptionPane.showMessageDialog(null, "O lucro sobre o produto foi de R$ " + dx + " reais");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoricoProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HistoricoProduto dialog = new HistoricoProduto(new javax.swing.JFrame(), true);
