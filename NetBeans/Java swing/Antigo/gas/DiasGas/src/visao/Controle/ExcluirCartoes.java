...
public class ExcluirCartoes extends javax.swing.JFrame {
ConexaoBD conex = new ConexaoBD();
BeansCartoes mod = new BeansCartoes();
DaoCartoes control = new DaoCartoes();
    public ExcluirCartoes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButtonExcluirCartão = new javax.swing.JButton();
        ...
        jButtonExcluirCartão.setText("Excluir cartão");
        jButtonExcluirCartão.setEnabled(false);
        jButtonExcluirCartão.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonExcluirCartãoActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jButtonExcluirCartão, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jButtonExcluirCartão)
                        .addGap(0, 0, Short.MAX_VALUE))
       ...
       String cliente_nome =""+jTableCartoes.getValueAt(jTableCartoes.getSelectedRow(), 0);
        ...
        conex.executaSql("select * from cartoes where codigo='"+ cliente_nome +"'");
           try {
               ...
               jButtonExcluirCartão.setEnabled(true);
    ...
    private void jButtonExcluirCartãoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirCartãoActionPerformed
         if(jTextFieldCodigo.getText().isEmpty()){
             JOptionPane.showMessageDialog(rootPane,"Selecione um cartão para excluir");
         }else{     
        int resposta = 0;
        resposta = JOptionPane.showConfirmDialog(rootPane,"Deseja realmente excluir um cartão");
         switch (resposta) {
    ...
    }//GEN-LAST:event_jButtonExcluirCartãoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExcluirCartoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExcluirCartoes().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton jButtonExcluirCartão;
