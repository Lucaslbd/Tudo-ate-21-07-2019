...
public class TelaEstoque extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/deposito/icones/mais.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/deposito/icones/alterar_registro.gif"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/deposito/icones/delete.gif"))); // NOI18N
        ...
        jLabel1.setText("Cadastro de estoque retornavel");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (lista == null || lista.size() < 1 || jTablePadrao.getSelectedRow() < 0) {
            ...
            TelaEstoqueCadastro dialog = new TelaEstoqueCadastro(new javax.swing.JFrame(), true, lista.get(jTablePadrao.getSelectedRow()));
            dialog.setVisible(true);
            pesquisar();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       if (lista == null || lista.size() < 1 || jTablePadrao.getSelectedRow() < 0) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                dao.excluirDiferente(lista.get(jTablePadrao.getSelectedRow()));               
            }
            pesquisar();
        }
    ...
    private void pesquisar() {
        lista = dao.listarComWhere("Estoque.listar", "nome", "Padrão");
        preencherTabela(lista);
    }

    private void preencherTabela(List<Estoque> ls) {
        String[] colunas = new String[]{"codigo", "nome", "vazios", "Custo do casco"};
        ArrayList dados = new ArrayList();
        if (ls == null || ls.size() < 1) {
            dados.add(new Object[]{"", "Nenhum registro encontrado", "", ""});
        } else {
            for (Estoque c : ls) {
                dados.add(new Object[]{c.getCodigo(), c.getNome(), c.getVazio(), util.decimalFormatComCifrao(c.getCustoCasco())});
            }
        }
        ...
        jTablePadrao.getColumnModel().getColumn(2).setPreferredWidth(80);
