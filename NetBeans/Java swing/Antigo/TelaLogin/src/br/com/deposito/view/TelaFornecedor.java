...
public class TelaFornecedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Registrar fornecedor");
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/deposito/icones/arrow_up (2).png"))); // NOI18N

        jLabel14.setBackground(new java.awt.Color(255, 255, 255));
        jLabel14.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Chegada de produtos");
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/deposito/icones/arrow_down (2).png"))); // NOI18N

        jLabel16.setBackground(new java.awt.Color(255, 255, 255));
        jLabel16.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Saida de produtos");
        ...
        jRadioButtonPlaca.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRadioButtonPlaca.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButtonPlaca.setSelected(true);
        jRadioButtonPlaca.setText("Busca por placa");
        ...
        jRadioButtonMarca.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRadioButtonMarca.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButtonMarca.setText("Busca por marca");
        jRadioButtonMarca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRadioButtonMarcaActionPerformed(evt);
            }
        });

        jRadioButtonModelo.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRadioButtonModelo.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButtonModelo.setText("Busca por modelo");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jRadioButtonMarca)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jPanelNovoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelNovoMouseClicked
        TelaFornecedorCadastro dialog = new TelaFornecedorCadastro(new javax.swing.JFrame(), true);
    ...
    private void jPanelNovo1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelNovo1MouseClicked
        if (lista == null || lista.size() < 1 || jTablePadrao.getSelectedRow() < 0) {
            ...
            TelaFornecedorCadastro dialog = new TelaFornecedorCadastro(new javax.swing.JFrame(), true, lista.get(jTablePadrao.getSelectedRow()));
            dialog.setVisible(true);
            pesquisar();
            jTextFieldPesquisar.requestFocus();
        }
    ...
    private void jPanelNovo2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelNovo2MouseClicked
        if (lista == null || lista.size() < 1 || jTablePadrao.getSelectedRow() < 0) {
            ...
            JOptionPane.showMessageDialog(this, "Ao remover um fornecedor também serão removidos todos seus registros", "Aviso", JOptionPane.WARNING_MESSAGE);
    ...
    private void jPanelNovo5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelNovo5MouseClicked
        if (lista == null || lista.size() < 1 || jTablePadrao.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(this, "Selecione um fornecedor para ter acesso a seu histórico de chagada de produtos", "Aviso", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jRadioButtonPlacaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonPlacaActionPerformed
        jRadioButtonPlaca.setSelected(true);
        jRadioButtonMarca.setSelected(false);
        jRadioButtonModelo.setSelected(false);
        jTextFieldPesquisar.requestFocus();
        jTextFieldPesquisar.setText("");
    }//GEN-LAST:event_jRadioButtonPlacaActionPerformed

    private void jRadioButtonMarcaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonMarcaActionPerformed
        jRadioButtonMarca.setSelected(true);
        jRadioButtonPlaca.setSelected(false);
        jRadioButtonModelo.setSelected(false);
        jTextFieldPesquisar.requestFocus();
        jTextFieldPesquisar.setText("");
    }//GEN-LAST:event_jRadioButtonMarcaActionPerformed
    ...
    private void jPanelNovo6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelNovo6MouseClicked
        if (lista == null || lista.size() < 1 || jTablePadrao.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(this, "Selecione um fornecedor para ter acesso a seu histórico de saida de produtos", "Aviso", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void pesquisar() {
        if (jRadioButtonPlaca.isSelected()) {
            lista = dao.listar("fornecedor.listaNome", "nome", jTextFieldPesquisar.getText());
        } else if (jRadioButtonMarca.isSelected()) {
            lista = dao.listar("fornecedor.listarCnpj", "cnpj", jTextFieldPesquisar.getText());
        } else if (jRadioButtonModelo.isSelected()) {
            lista = dao.listar("fornecedor.listarCidade", "cidade", jTextFieldPesquisar.getText());
        } else {
            lista = dao.listar("veiculos.listar");
        }
        preencherTabela(lista);
    }

    private void preencherTabela(List<Fornecedor> ls) {
        String[] colunas = new String[]{"Codigo", "Nome", "Cnpj", "Contato", "Cidade"};
        ArrayList dados = new ArrayList();
        if (ls == null || ls.size() < 1) {
            dados.add(new Object[]{"Nenhum registro encontrado", "", "", "", ""});
        } else {
            for (Fornecedor c : ls) {
                dados.add(new Object[]{c.getCodigo(), c.getNome(), c.getCnpj(), c.getContato(), c.getCidade()});
            }
        }
