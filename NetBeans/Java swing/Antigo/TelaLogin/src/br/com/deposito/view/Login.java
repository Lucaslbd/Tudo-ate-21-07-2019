...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/deposito/icones/telaUsuarioSenha01.png"))); // NOI18N
        ...
        jTextFieldEmail.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/deposito/icones/user-icon.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/deposito/icones/padlock.png"))); // NOI18N
        ...
        jLabel5.setBackground(new java.awt.Color(217, 81, 51));
        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(58, 65, 84));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextFieldEmail.getText().isEmpty()) {
            ...
            Usuario usuario = dao.Autenticar(jTextFieldEmail.getText(), jPasswordField1.getText());
            if (usuario == null) {
                JOptionPane.showMessageDialog(null, "Email ou senha invalidos: ", "Aviso", JOptionPane.WARNING_MESSAGE);
            } else {
    ...
    private void jButton2MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseEntered
        jButton2.setBackground(new Color(217, 81, 100));
    ...
    private void jLabel5MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseEntered
        jLabel5.setForeground(new Color(217, 81, 51));
    }//GEN-LAST:event_jLabel5MouseEntered

    private void jLabel5MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseExited
        jLabel5.setForeground(new Color(58, 65, 84));
