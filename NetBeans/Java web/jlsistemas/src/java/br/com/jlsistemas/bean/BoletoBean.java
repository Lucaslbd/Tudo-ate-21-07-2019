...
public class BoletoBean {
    ...
    int parcelas;
    ArrayList<Transacao> listaT = new ArrayList<>();

    public ArrayList<Transacao> getListaT() {
        return listaT;
    }

    public void setListaT(ArrayList<Transacao> listaT) {
        this.listaT = listaT;
    }
    ...
    public void pedirTransferencia() {
        ...
        try {
            ...
            if (response.isSuccess()) {
                ...
                tran.setDesconto(4.90);
                tran.setValor(liberado);
                dao.SalvarTransacao(tran);
