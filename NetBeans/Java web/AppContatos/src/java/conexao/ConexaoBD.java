...
public class ConexaoBD {
    ...
    private static final String USUARIO = "jlsistemasdegestao4";
    private static final String SENHA = "14811409lbd";
    private static final String URL = "jdbc:postgresql://pgsql.jlsistemasdegestao.com.br/jlsistemasdegestao4";
